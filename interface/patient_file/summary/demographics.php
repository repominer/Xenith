    ...
    <script>
        ...
        function setMyPatient() {
            ...
            if (isset($_GET['set_pid'])) {
                ...
                if (empty($date_of_death)) {
                    echo js_escape(" " . xl('DOB') . ": " . oeFormatShortDate($result['DOB_YMD']) . " " . xl('Age') . ": " . getPatientAgeDisplay($result['DOB_YMD']) . " " . "<br>" . (!empty($result['phone_cell']) ? $result["phone_cell"]: '') ." ". (!empty($result3['copay']) ? xl('Copay: $') . $result3['copay'] :'') );
                } else {
